...
public class TunerConstants {
    public final static double odometryUpdateFrequency = 0;
    public static Matrix<N3, N1> odometryStandardDeviation = VecBuilder.fill(.1,.1, Math.toRadians(5));
    public static Matrix<N3, N1> visionStandardDeviation = VecBuilder.fill(kInvalidStandardDeviation,kInvalidStandardDeviation, kInvalidStandardDeviation);
    ...
    public static CommandSwerveDrivetrain createDrivetrain() {
        return new CommandSwerveDrivetrain(
            DrivetrainConstants, odometryUpdateFrequency, odometryStandardDeviation, visionStandardDeviation, FrontLeft, FrontRight, BackLeft, BackRight
        );
    }
