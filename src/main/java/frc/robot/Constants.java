...
public final class Constants {
  ...
  public static class VisionConstants {
    ...
    // Position Constants
    public static final Translation2d kRobotToTurretTranslation = new Translation2d(0, .0); // The position of the center of the turret fron the center of the robot with +x towards the front of the robot and +y towards the left of the robot
